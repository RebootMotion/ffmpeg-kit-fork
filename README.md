...
To install ios-video binaries, please use the following commands:
```bash
brew install autoconf automake libtool pkg-config curl git cmake nasm
echo "export DEVELOPER_DIR=/Applications/Xcode_${{ version if multiple installed }}.app/Contents/Developer" > ~/.xcode.for.ffmpeg.kit.sh
./ios.sh --xcframework  --enable-dav1d --enable-fontconfig --enable-freetype --enable-fribidi --enable-kvazaar --enable-libass --enable-libtheora --enable-libvpx --enable-libwebp --enable-snappy --enable-zimg --enable-ios-audiotoolbox --enable-ios-avfoundation --enable-ios-bzip2 --enable-ios-videotoolbox --enable-ios-zlib
```
...
<img src="https://github.com/RebootMotion/ffmpeg-kit-fork/blob/main/docs/assets/ffmpeg-kit-icon-v9.png" width="240">
