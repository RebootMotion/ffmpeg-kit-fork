...
[Packages](https://github.com/RebootMotion/ffmpeg-kit-fork/wiki/Packages) wiki page to see the names of those
...
[LTS Releases](https://github.com/RebootMotion/ffmpeg-kit-fork/wiki/LTS-Releases) wiki page to see how they differ from each
other.
...
the [FFmpegKit Test](https://github.com/RebootMotion/ffmpeg-kit-fork-test) project.

### 5. Tips

See [Tips](https://github.com/RebootMotion/ffmpeg-kit-fork/wiki/Tips) wiki page.

### 6. License

See [License](https://github.com/RebootMotion/ffmpeg-kit-fork/wiki/License) wiki page.

### 7. Patents

See [Patents](https://github.com/RebootMotion/ffmpeg-kit-fork/wiki/Patents) wiki page.
